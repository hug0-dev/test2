...
class Chantier
{
    ...
    private ?array $chantier_prerequis = [];
    ...
    private ?User $chef_chantier = null;
    ...
    public function getChefChantier(): ?User
    {
        return $this->chef_chantier;
    }

    public function setChefChantier(?User $chef_chantier): static
    {
